            ...
            <form className="flex flex-col justify-center items-center bg-white px-5 py-[14px] max-w-[450px] w-full">
                ...
                <div className="flex flex-col gap-5 w-full items-center justify-center">
                    <label className="text-black flex flex-col w-full justify-center items-center">
                        ...
                        <input placeholder="Digite seu e-mail" className=" bg-slate-100 p-3 rounded-md min-w-[260px] outline-none lg:w-[300px]" />
                    </label>
                    <label className="text-black flex flex-col w-full justify-center items-center">
                        <h1 className="pb-2 pl-2 w-full max-w-[280px]">Senha*</h1>
                        <input placeholder="Digite sua senha" className="bg-slate-100 p-3 rounded-md min-w-[260px] outline-none lg:w-[300px]" />
                    </label>
